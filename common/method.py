...
if __name__=='__main__':
    get_cookie = requests.post(url='http://mall.api.epet.com/v3/login.html?do=postSubmit',
                               data={'postsubmit': 'r9b8s7m4', 'username': 'epet', 'password': 'epetbar'})
    m_cookie=get_cookie.cookies
    get_cookie._contentget_cookie=requests.post(url='http://mall.api.epet.com/v3/login.html?do=postSubmit',data={'postsubmit':'r9b8s7m4','username':'epet','password':'epetbar'})
    m_cookie=get_cookie.cookies
