...
#
#     def getIndexOfValue(self,sheet,rowNo=None,colsNo=None,rowNo1=None,colsNo1=None):
#         str1 = str(sheet.cell(row=rowNo, colsNo=colsNo))
#         str2= str(sheet.cell(row=rowNo1, colsNo=colsNo1))
#         target=str2.split(',')
#         if str1 and str2:
#             return 0
#         elif str1==str2:
